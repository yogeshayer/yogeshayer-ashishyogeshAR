...
- **Fix:**
  ...
  6. Check the **Runtime Logs** to verify the error is gone

**To check if variables are set:**
- Go to your deployment → Functions tab → View logs
- Look for "[v0] Missing Supabase environment variables" error messages
